		...
		for( int i = 0; i < mConfiguration.DistanceArcConfigs.Count; ++i )
		{
			...
			try
			{
				...
				if( ImGui.CollapsingHeader( String.Format( Loc.Localize( "Config Section Header: Distance Arc", "Distance Arc ({0})" ), name ) + "###DistanceArcHeader" ) )
				{
					...
					ImGui.InputTextWithHint( "###ArcNameInputBox", nameHint, ref config.mArcName, 50 );
					...
					ImGui.Checkbox( Loc.Localize( "Config Option: Arc Enabled", "Enabled" ) + "###Arc Enabled Checkbox", ref config.mEnabled );
					if( ImGui.TreeNode( Loc.Localize( "Config Section Header: Distance Arc Rules", "Distance Rules" ) + "###DistanceArcRulesHeader" ) )
					{
						...
						else if( config.ApplicableTargetCategory == TargetCategory.Self )
						{
							...
							ImGui.DragInt( "###ArcSelfAzimuthSlider", ref config.mSelfTargetedArcAzimuth_Deg, 1f, 0, 359, "%d", ImGuiSliderFlags.AlwaysClamp );
							ImGui.Checkbox( Loc.Localize( "Config Option: Camera-relative Self Arc", "Camera Relative" ) + "###ArcSelfCameraRelativeCheckbox", ref config.mSelfTargetedArcCameraRelative );
						}
						else if( config.ApplicableTargetCategory == TargetCategory.AllEnemies )
						{
							ImGui.Checkbox( Loc.Localize( "Config Option: All Enemies Aggressive", "Show Aggressive" ) + "###ArcAllEnemiesAggressiveCheckbox", ref config.mAllEnemiesShowAggressive );
							ImGui.Checkbox( Loc.Localize( "Config Option: All Enemies Unaggressive", "Show Unaggressive" ) + "###ArcAllEnemiesUnaggressiveCheckbox", ref config.mAllEnemiesShowUnaggressive );
							ImGui.Checkbox( Loc.Localize( "Config Option: Show Dead Objects", "Show Dead" ) + "###ShowDeadObjectsCheckbox", ref config.mShowDeadObjects );
						}
						else if( config.ApplicableTargetCategory == TargetCategory.AllPlayers )
						{
							ImGui.Checkbox( Loc.Localize( "Config Option: All Players Party", "Show Party Members" ) + "###ArcAllPlayersPartyCheckbox", ref config.mAllPlayersShowParty );
							ImGui.Checkbox( Loc.Localize( "Config Option: All Players Alliance", "Show Alliance Members" ) + "###ArcAllPlayersAllianceCheckbox", ref config.mAllPlayersShowAlliance );
							ImGui.Checkbox( Loc.Localize( "Config Option: All Players Other", "Show Other Players" ) + "###ArcAllPlayersOtherCheckbox", ref config.mAllPlayersShowOthers );
							ImGui.Checkbox( Loc.Localize( "Config Option: Show Dead Objects", "Show Dead" ) + "###ShowDeadObjectsCheckbox", ref config.mShowDeadObjects );
						}

						ImGui.Checkbox( Loc.Localize( "Config Option: Distance is to Ring", "Use distance to target ring, not target center." ) + "###ArcDistanceIsToRingCheckbox", ref config.mDistanceIsToRing );
					...
					{
						ImGui.Checkbox( Loc.Localize( "Config Option: Show Arc on Players", "Show the arc on players." ) + "###Show arc on players", ref filters.mShowDistanceOnPlayers );
						ImGui.Checkbox( Loc.Localize( "Config Option: Show Arc on BattleNpc", "Show the arc on combatant NPCs." ) + "###Show arc on BattleNpc", ref filters.mShowDistanceOnBattleNpc );
						ImGui.Checkbox( Loc.Localize( "Config Option: Show Arc on EventNpc", "Show the arc on non-combatant NPCs." ) + "###Show arc on EventNpc", ref filters.mShowDistanceOnEventNpc );
						ImGui.Checkbox( Loc.Localize( "Config Option: Show Arc on Treasure", "Show the arc on treasure chests." ) + "###Show arc on treasure", ref filters.mShowDistanceOnTreasure );
						ImGui.Checkbox( Loc.Localize( "Config Option: Show Arc on Aetheryte", "Show the arc on aetherytes." ) + "###Show arc on aetheryte", ref filters.mShowDistanceOnAetheryte );
						ImGui.Checkbox( Loc.Localize( "Config Option: Show Arc on Gathering Node", "Show the arc on gathering nodes." ) + "###Show arc on gathering node", ref filters.mShowDistanceOnGatheringNode );
						ImGui.Checkbox( Loc.Localize( "Config Option: Show Arc on EventObj", "Show the arc on interactable objects." ) + "###Show arc on EventObj", ref filters.mShowDistanceOnEventObj );
						ImGui.Checkbox( Loc.Localize( "Config Option: Show Arc on Companion", "Show the arc on companions." ) + "###Show arc on companion", ref filters.mShowDistanceOnCompanion );
						ImGui.Checkbox( Loc.Localize( "Config Option: Show Arc on Housing", "Show the arc on housing items." ) + "###Show arc on housing", ref filters.mShowDistanceOnHousing );
						ImGui.TreePop();
					}
					...
					{
						ImGui.Checkbox( Loc.Localize( "Config Option: Show Arc Pip", "Show Pip." ) + "###ArcShowPip", ref config.mShowPip );
						...
						ImGui.SliderFloat( "###ArcLengthSlider", ref config.mArcLength, 0, 30 );

						ImGui.Text( Loc.Localize( "Config Option: Distance Arc Inside Fade Distance", "Distance inside the arc to start fading (y):" ) );
						ImGui.DragFloat( "###ArcDistanceInnerFadeThresholdSlider", ref config.mFadeoutThresholdInner_Yalms, 0.5f, 1f, 30f, "%g", ImGuiSliderFlags.AlwaysClamp );
						ImGui.Text( Loc.Localize( "Config Option: Distance Arc Inside Fade Interval", "Fade over (y):" ) );
						ImGui.DragFloat( "###ArcDistanceInnerFadeIntervalSlider", ref config.mFadeoutIntervalInner_Yalms, 0.5f, 0f, 30f, "%g", ImGuiSliderFlags.AlwaysClamp );
						ImGui.Text( Loc.Localize( "Config Option: Distance Arc Outside Fade Distance", "Distance outside the arc to start fading (y):" ) );
						ImGui.DragFloat( "###ArcDistanceOuterFadeThresholdSlider", ref config.mFadeoutThresholdOuter_Yalms, 0.5f, 1f, 30f, "%g", ImGuiSliderFlags.AlwaysClamp );
						ImGui.Text( Loc.Localize( "Config Option: Distance Arc Outside Fade Interval", "Fade over (y):" ) );
						ImGui.DragFloat( "###ArcDistanceOuterFadeIntervalSlider", ref config.mFadeoutIntervalOuter_Yalms, 0.5f, 0f, 30f, "%g", ImGuiSliderFlags.AlwaysClamp );
					...
					if( ImGui.TreeNode( Loc.Localize( "Config Section Header: Distance Arc Colors", "Colors" ) + "###Distance Arc Colors Header" ) )
					{
						...
						{
							ImGui.Checkbox( Loc.Localize( "Config Option: Distance Arc Use Distance-based Colors", "Use distance-based arc colors." ) + "###DistanceArcUseDistanceBasedColors", ref config.mUseDistanceBasedColor );
						}
						...
						ImGui.ColorEdit4( Loc.Localize( "Config Option: Distance Arc Color", "Distance text color" ) + "###ArcColorPicker", ref config.mColor, ImGuiColorEditFlags.NoInputs );
						ImGui.ColorEdit4( Loc.Localize( "Config Option: Distance Arc Glow Color", "Distance text glow color" ) + "###ArcEdgeColorPicker", ref config.mEdgeColor, ImGuiColorEditFlags.NoInputs );
						if( config.UseDistanceBasedColor && config.ApplicableTargetCategory != TargetCategory.Self )
						{
							ImGui.ColorEdit4( Loc.Localize( "Config Option: Distance Arc Color Inside Far", "Arc color (inside near)" ) + "###ArcColorPickerInnerNear", ref config.mInnerNearThresholdColor, ImGuiColorEditFlags.NoInputs );
							ImGui.ColorEdit4( Loc.Localize( "Config Option: Distance Arc Glow Color Inside Far", "Arc glow color (inside near)" ) + "###ArcEdgeColorPickerInnerNear", ref config.mInnerNearThresholdEdgeColor, ImGuiColorEditFlags.NoInputs );
							ImGui.ColorEdit4( Loc.Localize( "Config Option: Distance Arc Color Inside Far", "Arc color (inside far)" ) + "###ArcColorPickerInnerFar", ref config.mInnerFarThresholdColor, ImGuiColorEditFlags.NoInputs );
							ImGui.ColorEdit4( Loc.Localize( "Config Option: Distance Arc Glow Color Inside Far", "Arc glow color (inside far)" ) + "###ArcEdgeColorPickerInnerFar", ref config.mInnerFarThresholdEdgeColor, ImGuiColorEditFlags.NoInputs );
							ImGui.Text( Loc.Localize( "Config Option: Distance Arc Inside Near Range", "Distance \"inside near\" range (y):" ) );
							ImGui.DragFloat( "###ArcDistanceNearInsideRangeSlider", ref config.mInnerNearThresholdDistance_Yalms, 0.5f, 0f, 30f );
							ImGui.Text( Loc.Localize( "Config Option: Distance Arc Inside Far Range", "Distance \"inside far\" range (y):" ) );
							ImGui.DragFloat( "###ArcDistanceFarInsideRangeSlider", ref config.mInnerFarThresholdDistance_Yalms, 0.5f, 0f, 30f );

							ImGui.ColorEdit4( Loc.Localize( "Config Option: Distance Arc Color Outside Far", "Arc color (outside near)" ) + "###ArcColorPickerOuterNear", ref config.mOuterNearThresholdColor, ImGuiColorEditFlags.NoInputs );
							ImGui.ColorEdit4( Loc.Localize( "Config Option: Distance Arc Glow Color Outside Far", "Arc glow color (outside near)" ) + "###ArcEdgeColorPickerOuterNear", ref config.mOuterNearThresholdEdgeColor, ImGuiColorEditFlags.NoInputs );
							ImGui.ColorEdit4( Loc.Localize( "Config Option: Distance Arc Color Outside Far", "Arc color (outside far)" ) + "###ArcColorPickerOuterFar", ref config.mOuterFarThresholdColor, ImGuiColorEditFlags.NoInputs );
							ImGui.ColorEdit4( Loc.Localize( "Config Option: Distance Arc Glow Color Outside Far", "Arc glow color (outside far)" ) + "###ArcEdgeColorPickerOuterFar", ref config.mOuterFarThresholdEdgeColor, ImGuiColorEditFlags.NoInputs );
							ImGui.Text( Loc.Localize( "Config Option: Distance Arc Outside Near Range", "Distance \"outside near\" range (y):" ) );
							ImGui.DragFloat( "###ArcDistanceNearOutsideRangeSlider", ref config.mOuterNearThresholdDistance_Yalms, 0.5f, 0f, 30f );
							ImGui.Text( Loc.Localize( "Config Option: Distance Arc Outside Far Range", "Distance \"outside far\" range (y):" ) );
							ImGui.DragFloat( "###ArcDistanceFarOutsideRangeSlider", ref config.mOuterFarThresholdDistance_Yalms, 0.5f, 0f, 30f );
						}
						ImGui.TreePop();
					}

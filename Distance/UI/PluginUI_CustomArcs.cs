	...
	private void DrawConfigOptions( int i )
	{
		...
		try
		{
			...
			if( ImGui.TreeNode( Loc.Localize( "Config Section Header: Distance Arc Rules", "Distance Rules" ) + "###DistanceArcRulesHeader" ) )
			{
				...
				ImGui.Text( String.Format( Loc.Localize( "Config Option: Arc Radius", "The radius of the arc ({0}):" ), LocalizationHelpers.DistanceUnitShort ) );
				ImGuiUtils.HelpMarker( String.Format( Loc.Localize( "Help: Arc Radius", "This distance is relative to either the object's center, or to its hitring, as configured above.  Max melee is effectively 3.5{0}." ), LocalizationHelpers.DistanceUnitShort ) );
			...
			if( ImGui.TreeNode( Loc.Localize( "Config Section Header: Distance Arc Appearance", "Appearance" ) + "###DistanceArcAppearanceHeader" ) )
			{
				...
				if( ImGui.RadioButton( Loc.Localize( "Unit String: Degrees Short Lower", "deg" ) + "###ButtonUnitsDegrees", !config.ArcLengthIsYalms ) ) config.ArcLengthIsYalms = false;
				ImGui.SameLine();
				if( ImGui.RadioButton( LocalizationHelpers.DistanceUnitLowerPlural + "###ButtonUnitsYalms", config.ArcLengthIsYalms ) ) config.ArcLengthIsYalms = true;
			...
			if( ImGui.TreeNode( Loc.Localize( "Config Section Header: Distance Arc Colors", "Colors" ) + "###Distance Arc Colors Header" ) )
			{
				if( config.ApplicableTargetCategory != TargetCategory.Self )
				{
					...
					ImGuiUtils.HelpMarker( Loc.Localize( "Help: Distance Arc Use Distance-based Colors", "Allows you to set different colors for different distance thresholds.  Uses the \"Far\" colors if past that distance, otherwise the \"Near\" colors if past that distance, otherwise uses the base color specified below." ) );
				}
				...
				if( config.UseDistanceBasedColor && config.ApplicableTargetCategory != TargetCategory.Self )
				{
					...
					ImGui.Text( String.Format( Loc.Localize( "Config Option: Distance Arc Inside Near Range", "Distance \"inside near\" range ({0}):" ), LocalizationHelpers.DistanceUnitShort ) );
					ImGui.DragFloat( "###ArcDistanceNearInsideRangeSlider", ref config.InnerNearThresholdDistance_Yalms, 0.5f, 0f, 30f );
					ImGui.Text( String.Format( Loc.Localize( "Config Option: Distance Arc Inside Far Range", "Distance \"inside far\" range ({0}):" ), LocalizationHelpers.DistanceUnitShort ) );
					...
					ImGui.Text( String.Format( Loc.Localize( "Config Option: Distance Arc Outside Near Range", "Distance \"outside near\" range ({0}):" ), LocalizationHelpers.DistanceUnitShort ) );
					ImGui.DragFloat( "###ArcDistanceNearOutsideRangeSlider", ref config.OuterNearThresholdDistance_Yalms, 0.5f, 0f, 30f );
					ImGui.Text( String.Format( Loc.Localize( "Config Option: Distance Arc Outside Far Range", "Distance \"outside far\" range ({0}):" ), LocalizationHelpers.DistanceUnitShort ) );
			...
			{
				ImGui.Text( String.Format( Loc.Localize( "Config Option: Distance Arc Inside Fade Distance", "Distance inside the arc to start fading ({0}):" ), LocalizationHelpers.DistanceUnitShort ) );
				...
				ImGui.Text( String.Format( Loc.Localize( "Config Option: Distance Arc Inside Fade Interval", "Fade over ({0}):" ), LocalizationHelpers.DistanceUnitShort ) );
				...
				ImGui.Text( String.Format( Loc.Localize( "Config Option: Distance Arc Outside Fade Distance", "Distance outside the arc to start fading ({0}):" ), LocalizationHelpers.DistanceUnitShort ) );
				...
				ImGui.Text( String.Format( Loc.Localize( "Config Option: Distance Arc Outside Fade Interval", "Fade over ({0}):" ), LocalizationHelpers.DistanceUnitShort ) );
